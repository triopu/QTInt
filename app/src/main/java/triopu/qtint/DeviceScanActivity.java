...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id){
        ...
        final Intent intent = new Intent(this, MainQT.class);
        intent.putExtra(MainQT.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(MainQT.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if(scanning){
